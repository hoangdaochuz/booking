...
const file_proto_user_v1_user_proto_rawDesc = "" +
	"\n" +
	"\x18proto/user/v1/user.proto\x12\auser.v1\x1a\x1fgoogle/protobuf/timestamp.proto\"W\n" +
	...
	"\x04role\x18\x04 \x01(\tR\x04role2\xd7\x03\n" +
	"\vUserService\x12;\n" +
	"\bRegister\x12\x18.user.v1.RegisterRequest\x1a\x15.user.v1.AuthResponse\x125\n" +
	"\x05Login\x12\x15.user.v1.LoginRequest\x1a\x15.user.v1.AuthResponse\x12C\n" +
	"\fRefreshToken\x12\x1c.user.v1.RefreshTokenRequest\x1a\x15.user.v1.AuthResponse\x129\n" +
	"\x06Logout\x12\x16.user.v1.LogoutRequest\x1a\x17.user.v1.LogoutResponse\x12>\n" +
	"\n" +
	"GetProfile\x12\x1a.user.v1.GetProfileRequest\x1a\x14.user.v1.UserProfile\x12D\n" +
	"\rUpdateProfile\x12\x1d.user.v1.UpdateProfileRequest\x1a\x14.user.v1.UserProfile\x12N\n" +
	"\rValidateToken\x12\x1d.user.v1.ValidateTokenRequest\x1a\x1e.user.v1.ValidateTokenResponseB/Z-github.com/ticketbox/pkg/proto/user/v1;userv1b\x06proto3"
...
var file_proto_user_v1_user_proto_depIdxs = []int32{
	8,  // 0: user.v1.AuthResponse.user:type_name -> user.v1.UserProfile
	11, // 1: user.v1.UserProfile.created_at:type_name -> google.protobuf.Timestamp
	...
	3,  // 4: user.v1.UserService.RefreshToken:input_type -> user.v1.RefreshTokenRequest
	4,  // 5: user.v1.UserService.Logout:input_type -> user.v1.LogoutRequest
	6,  // 6: user.v1.UserService.GetProfile:input_type -> user.v1.GetProfileRequest
	7,  // 7: user.v1.UserService.UpdateProfile:input_type -> user.v1.UpdateProfileRequest
	9,  // 8: user.v1.UserService.ValidateToken:input_type -> user.v1.ValidateTokenRequest
	2,  // 9: user.v1.UserService.Register:output_type -> user.v1.AuthResponse
	2,  // 10: user.v1.UserService.Login:output_type -> user.v1.AuthResponse
	2,  // 11: user.v1.UserService.RefreshToken:output_type -> user.v1.AuthResponse
	5,  // 12: user.v1.UserService.Logout:output_type -> user.v1.LogoutResponse
	8,  // 13: user.v1.UserService.GetProfile:output_type -> user.v1.UserProfile
	8,  // 14: user.v1.UserService.UpdateProfile:output_type -> user.v1.UserProfile
	10, // 15: user.v1.UserService.ValidateToken:output_type -> user.v1.ValidateTokenResponse
